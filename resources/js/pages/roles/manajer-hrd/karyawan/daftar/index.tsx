  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Karyawan', href: '#' },
        { title: 'Daftar Karyawan', href: '/roles/manajer-hrd/karyawan/daftar' }
      ]}
    >
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold">Daftar Karyawan
            {pendingChangeRequestsCount > 0 && (
              <a href={route('manajer-hrd.karyawan.permintaan-perubahan-data')} className="inline-flex items-center">
                    ...
                    <tr key={employee.id_karyawan} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex gap-1">
                          <Link href={route('manajer-hrd.karyawan.detail', { id: employee.id_karyawan })}>
