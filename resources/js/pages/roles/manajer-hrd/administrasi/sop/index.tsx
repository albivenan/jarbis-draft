...
export default function PeraturanSOP({ sops }: { sops: SOP[] }) {
  ...
  const handleDelete = (sop: SOP) => {
    if (window.confirm(`Apakah Anda yakin ingin menghapus SOP "${sop.title}"?`)) {
      router.delete(route('manajer-hrd.administrasi.sop.destroy', sop.id));
    }
  };
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <Link href={route('manajer-hrd.administrasi.sop.create')}>
              <Button>
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex flex-col gap-2 ml-6">
                    <Link href={route('manajer-hrd.administrasi.sop.show', sop.id)}>
                    ...
                    <Link href={route('manajer-hrd.administrasi.sop.edit', sop.id)}>
                      <Button size="sm" variant="outline">
