...
export default function RiwayatPengumuman({ pengumuman }: PengumumanPageProps) {
    ...
    const handleDelete = (id: number) => {
        router.delete(route('manajer-hrd.pengumuman.destroy', { pengumuman: id }), {
            onSuccess: () => {
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumbs={[
                ...
                { title: 'Pengumuman', href: '/roles/manajer-hrd/pengumuman/riwayat' },
                { title: 'Riwayat Pengumuman', href: '/roles/manajer-hrd/pengumuman/riwayat' }
            ]}
        >
                                    ...
                                    pengumuman.data.map((item) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell className="flex items-center space-x-2">
                                                <Link href={route('manajer-hrd.pengumuman.riwayat.show', { pengumuman: item.id })} className="text-blue-600 hover:underline">
                                                    Lihat
                                                </Link>
                                                <AlertDialog>
