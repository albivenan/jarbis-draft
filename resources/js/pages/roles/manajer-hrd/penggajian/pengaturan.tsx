...
export default function PengaturanPenggajianPage({ jabatans, tarifPerJamRules: initialTarifPerJamRules, standarJamKerja }: PengaturanPenggajianProps) {
    ...
    const handleSaveAllSettings = () => {
        ...
        router.post(route('manajer-hrd.penggajian.pengaturan.update'), { tarifPerJamRules }, {
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumbs={[{ title: 'Dashboard', href: '/roles/manajer-hrd' }, { title: 'Manajemen Penggajian', href: '#' }, { title: 'Pengaturan', href: route('manajer-hrd.penggajian.pengaturan') }]}
        >
