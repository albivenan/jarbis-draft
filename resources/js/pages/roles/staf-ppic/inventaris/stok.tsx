...
import { Package, Search, AlertTriangle, TrendingUp, TrendingDown, Eye } from 'lucide-react';
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Stok Bahan Baku', href: '/roles/staf-ppic/inventaris/stok' }
      ]}
    >
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Monitor stok bahan baku produksi</p>
          </div>
        </div>
