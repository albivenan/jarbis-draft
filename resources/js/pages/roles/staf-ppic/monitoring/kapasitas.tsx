  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Analisis Kapasitas', href: '/roles/staf-ppic/monitoring/kapasitas' }
      ]}
    >
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Lihat analisis utilisasi kapasitas produksi per divisi</p>
          </div>
        </div>
