...
export default function PermintaanPembelian() {
    ...
    useEffect(() => {
        ...
        router.get(route('manajer-ppic.inventaris.pembelian.index'), Object.fromEntries(queryParams.entries()), {
            preserveState: true,
            preserveScroll: true,
            replace: true,
        });
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Permintaan Pembelian', href: route('manajer-ppic.inventaris.pembelian.index') }
      ]}
    >
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Link href={route('manajer-ppic.inventaris.pembelian.create')}>
