...
export default function AntreanPesanan() {
  ...
  useEffect(() => {
    router.get(route('manajer-ppic.perencanaan.pesanan.index'), {
  ...
  const handleSubmitHargaUsulanPpic = (order: Pesanan) => {
    ...
    router.put(route('manajer-ppic.perencanaan.pesanan.submit-price', order.id), {
  ...
  const handleApproveTenggat = (order: Pesanan) => {
    router.put(route('manajer-ppic.perencanaan.pesanan.approve-tenggat', order.id), {}, {
      onSuccess: () => {
  ...
  const handleRejectTenggat = (order: Pesanan) => {
    ...
    router.put(route('manajer-ppic.perencanaan.pesanan.reject-tenggat', order.id), {
  ...
  const handleUpdateTenggat = (order: Pesanan) => {
    ...
    router.put(route('manajer-ppic.perencanaan.pesanan.update-tenggat', order.id), {
  ...
  return (
    <AuthenticatedLayout
            ...
            breadcrumbs={[
                { title: 'Dashboard', href: route('manajer-ppic.index') },
                { title: 'Perencanaan', href: '#' },
                { title: 'Antrean Pesanan', href: route('manajer-ppic.perencanaan.pesanan.index') }
            ]}
        >
