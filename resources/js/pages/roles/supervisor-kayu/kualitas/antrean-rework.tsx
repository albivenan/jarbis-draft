  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Antrean Rework', href: '/roles/supervisor-kayu/kualitas/antrean-rework' }
      ]}
    >
      <Head title="Antrean Pengerjaan Ulang - Supervisor Kayu" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Kelola pengerjaan ulang produk kayu yang ditolak QC</p>
          </div>
        </div>
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Fitur antrean rework untuk Supervisor Kayu sedang dalam tahap pengembangan.
              </p>
