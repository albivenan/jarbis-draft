...
export default function Dashboard({ roleInfo }: DashboardProps) {
  ...
  const myTasks = [
    ...
    {
      id: 'TASK-KY-002',
      title: 'Kursi Kayu Mahoni Set 6pcs',
      workOrder: 'WO-KY-002',
      quantity: 40,
      progress: 60,
      deadline: '2024-01-25',
    ...
    {
      id: 'TASK-KY-003',
      title: 'Rework - Perbaikan Finishing',
      workOrder: 'WO-KY-001-RW',
      quantity: 3,
      progress: 100,
      deadline: '2024-01-18',
      status: 'completed',
  ...
  return (
    <AuthenticatedLayout
      title="Dashboard Supervisor Kayu"
      breadcrumbs={[
        { title: 'Dashboard', href: '/roles/supervisor-kayu' }
      ]}
    >
      <Head title="Dashboard Supervisor Kayu" />
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
              ...
              Dashboard Supervisor Kayu
            </h1>
            <p className="text-gray-600 mt-1">{roleInfo?.description || 'Mengawasi dan mengelola operasional produksi kayu'}</p>
          </div>
