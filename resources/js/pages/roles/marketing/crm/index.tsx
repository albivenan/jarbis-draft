...
export default function CrmIndex() {
    ...
    const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        router.get(route('marketing.crm.index'), {
    ...
    const handleNewOrderSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('marketing.pesanan.store'), newOrderForm, {
            onSuccess: () => {
    ...
    const handleConfirmOrder = (order: Pesanan) => {
        ...
        router.put(route('marketing.pesanan.confirm', order.id), {}, {
            onSuccess: () => {
    ...
    const handleRejectOrder = (order: Pesanan) => {
        ...
        if (confirm('Apakah Anda yakin ingin menolak pesanan ini?')) {
            router.put(route('marketing.pesanan.reject', order.id), {}, {
                onSuccess: () => {
    ...
    const handleCancelOrder = (order: Pesanan) => {
        if (confirm('Apakah Anda yakin ingin membatalkan pesanan ini?')) {
            router.put(route('marketing.pesanan.cancel', order.id), {}, {
                onSuccess: () => {
    ...
    const handleBandingSubmit = (order: Pesanan) => {
        ...
        router.put(route('marketing.pesanan.banding', order.id), {
    ...
    const handleBandingTenggatSubmit = (order: Pesanan) => {
        ...
        router.put(route('marketing.pesanan.banding-tenggat', order.id), {
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumbs={[
                { title: 'Dashboard', href: route('marketing.index') },
                { title: 'CRM', href: route('marketing.crm.index') }
            ]}
        >
