  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Alokasi Tugas Operator', href: '/roles/manajer-produksi-kayu/manajemen-produksi/alokasi-tugas' }
      ]}
    >
      <Head title="Alokasi Tugas Operator - Manajer Produksi Kayu" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Kelola dan alokasikan tugas kepada operator produksi kayu</p>
          </div>
          <Dialog>
