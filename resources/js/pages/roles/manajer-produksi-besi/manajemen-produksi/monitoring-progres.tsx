...
export default function MonitoringProgres() {
  ...
  const workOrders = [
    ...
    },
    {
      ...
      tasks: [
        {
          id: 'TASK-004',
          name: 'Pembuatan Ornamen',
          operator: 'Candra Wijaya',
          status: 'in_progress',
          progress: 40,
          estimatedHours: 8,
          actualHours: 3,
        ...
        {
          id: 'TASK-005',
          name: 'Pemasangan Frame',
          operator: 'Eko Susanto',
          status: 'pending',
          progress: 0,
          estimatedHours: 6,
          actualHours: 0,
  ...
  const operators = [
    { id: 'OP-001', name: 'Ahmad Santoso', currentTasks: 2, efficiency: 95 },
    { id: 'OP-002', name: 'Budi Prasetyo', currentTasks: 1, efficiency: 88 },
    { id: 'OP-003', name: 'Candra Wijaya', currentTasks: 1, efficiency: 92 },
    { id: 'OP-004', name: 'Dedi Kurniawan', currentTasks: 1, efficiency: 90 },
    { id: 'OP-005', name: 'Eko Susanto', currentTasks: 1, efficiency: 85 }
  ];
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Monitoring Progres Lapangan', href: '/roles/manajer-produksi-besi/manajemen-produksi/monitoring-progres' }
      ]}
    >
      <Head title="Monitoring Progres Lapangan - Manajer Produksi Besi" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Monitor progres real-time produksi besi di lapangan</p>
          </div>
        </div>
