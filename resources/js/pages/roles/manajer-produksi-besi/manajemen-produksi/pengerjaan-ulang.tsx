...
export default function PengerjaanUlang() {
  ...
  const reworkItems = [
    {
      ...
      originalTask: 'Pengelasan H-Beam Utama',
      qcRejectReason: 'Ditemukan undercut pada sambungan las, penetrasi tidak optimal',
      reportedBy: 'QC Besi - Indra Wijaya',
    ...
    },
    {
      ...
      originalTask: 'Pemasangan Ornamen Detail',
      qcRejectReason: 'Jarak antar ornamen tidak konsisten, beberapa sambungan kurang kuat',
      reportedBy: 'QC Besi - Indra Wijaya',
    ...
    },
    {
      ...
      workOrder: 'WO-BSI-001',
      product: 'Rangka Besi H-Beam 200x100',
      originalTask: 'Finishing Cat Anti Karat',
      qcRejectReason: 'Lapisan cat tidak merata, ditemukan area yang terlewat',
      reportedBy: 'QC Besi - Indra Wijaya',
      reportedDate: '2025-01-03',
      priority: 'low',
      status: 'completed',
      estimatedReworkTime: 3,
      assignedOperator: 'Dedi Kurniawan',
      dueDate: '2025-01-05',
      actualStartTime: '2025-01-04 13:00',
      actualEndTime: '2025-01-05 15:00',
      progress: 100,
  ...
  const operators = [
    { id: 'OP-001', name: 'Ahmad Santoso', skill: 'Pengelasan SMAW/TIG', availability: 'available' },
    { id: 'OP-002', name: 'Budi Prasetyo', skill: 'Cutting & Grinding', availability: 'busy' },
    { id: 'OP-003', name: 'Candra Wijaya', skill: 'Assembly & Fitting', availability: 'available' },
    { id: 'OP-004', name: 'Dedi Kurniawan', skill: 'Finishing & Painting', availability: 'available' },
    { id: 'OP-005', name: 'Eko Susanto', skill: 'Pengelasan SMAW', availability: 'available' }
  ];
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Permintaan Pengerjaan Ulang (Rework)', href: '/roles/manajer-produksi-besi/manajemen-produksi/pengerjaan-ulang' }
      ]}
    >
      <Head title="Permintaan Pengerjaan Ulang (Rework) - Manajer Produksi Besi" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Kelola permintaan pengerjaan ulang dari QC untuk produk besi</p>
          </div>
          <Dialog>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input placeholder="Contoh: WO-BSI-001" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-2 block">
