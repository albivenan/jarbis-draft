...
export default function ProsesPenggajianPage() {
    ...
    useEffect(() => {
        if (activeTab === 'riwayat') {
            ...
            router.get(route('hrd.penggajian.proses'), { tab: 'riwayat', statuses: ['paid', 'rejected', 'finalized'] }, {
                preserveState: true,
                replace: true,
                onSuccess: (page) => {
            ...
            router.get(route('hrd.penggajian.proses'), { tab: 'pending_payment', statuses: ['approved'] }, {
                preserveState: true,
                replace: true,
                onSuccess: (page) => {
    ...
    const handleStartPayrollProcess = (period: { value: string; label: string; }) => {
        ...
        router.get(route('hrd.penggajian.proses'), { period: period.value }, {
            preserveState: true,
            replace: true,
            onStart: () => {
    ...
    const handleValidate = () => {
        ...
        router.post(route('hrd.penggajian.proses.validate'),
