...
export default function PermintaanPerubahanDataPage() {
  ...
  const handleApprove = (id: number) => {
    router.post(route('hrd.karyawan.approve-data-change-request', { id }), {}, {
      onSuccess: () => {
        router.reload();
      },
  ...
  const handleReject = (id: number) => {
    router.post(route('hrd.karyawan.reject-data-change-request', { id }), {}, {
      onSuccess: () => {
        router.reload();
      },
      onError: (errors: Record<string, string>) => {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { title: 'Karyawan', href: '#' },
        { title: 'Permintaan Perubahan Data', href: '/roles/hrd/karyawan/permintaan-perubahan-data' }
      ]}
    >
